...
def apply_smrf(points, cell_size=1.0, slope=0.2, window=18, elevation_threshold=0.5):
    ...
    5. Retourner un masque (True = sol, False = non-sol).
    """
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if st.button("Lancer le traitement"):
            ...
            # Vérification pour éviter un array vide pour DBSCAN
            ...
            for label in unique_labels:
                ...
                if len(cluster_pts) >= cluster_min_points:
                    # Extraction de segment par PCA ou autre (à compléter selon le besoin)
