...
if uploaded_file is not None:
    ...
    if custom_layer_enabled:
        ...
        # Convertir l'image PIL en bytes avant de l'envoyer à streamlit_image_coordinates
        img_bytes = BytesIO()
        ...
        coords = streamlit_image_coordinates(
            ...
            img_bytes,  # <--- On envoie des bytes, et non plus un chemin ou un objet PIL brut
            key="custom_pipette"
        )
